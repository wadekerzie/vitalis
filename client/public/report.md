...
## 5. AI Consulting Engagement: Three-Phase Commercial Structure

The AI component of Vitalis is not a vendor relationship—it is a foundational investment in proprietary intellectual property. The engagement is structured in three distinct phases with separate commercial terms. Each phase is independently contracted and separately priced. **No phase begins without a signed agreement and payment on account.** There is no participation in the upside of Vitalis's success, no deferred compensation, and no equity arrangement. The expertise required to build this system has been earned over decades of production deployments—it is not speculative, and it will not be provided on an if-come basis.

| Phase | Description | Commercial Structure | Capital vs. Operating |
| :--- | :--- | :--- | :--- |
| **Phase 0** | Strategic Architecture Engagement — 30-day blueprint, IP transfer, working prototypes | Fixed fee, paid before work begins | **Capital expenditure** (inside the investment raise) |
| **Phase 1** | Production Deployment — full build, go-live, staff training | Fixed fee, milestone-gated | **Capital expenditure** (inside the investment raise) |
| **Phase 2** | AI Operations Retainer — dedicated engineer, ongoing maintenance | Monthly retainer | **Operating expense** (P&L line item) |
...
### 5.2. Phase 0: Strategic Architecture Engagement

Phase 0 is the gate through which all subsequent work passes. It is a **30-day, fixed-fee engagement** that produces the complete technical blueprint for the Vitalis proprietary infrastructure. No production deployment begins without Phase 0 deliverables in hand. The output is not a slide deck—it is production-ready architecture documentation, working prototypes, and documented frameworks that the deployment team executes directly.
...
Phase 1 is the full build: on-premise LLM deployment, custom EMR implementation, Vitalis Score engine, physician dashboard, lab API integrations, wearable ingestion, security audit, staff training, and go-live support. Phase 1 is separately scoped after Phase 0 deliverables are accepted.

| Component | Detail |
| :--- | :--- |
| **Duration** | 60–90 days |
| **Fee** | $200,000 fixed fee |
| **Payment Terms** | Milestone-gated: 30% upfront, 40% at prototype acceptance, 30% at go-live |
| **IP Transfer** | All code, documentation, and configurations owned by Vitalis |
| **Capital Classification** | Capital expenditure — included as a line item in the Vitalis investment raise |

### 5.4. Phase 2: Kerzie AI Managed Services Retainer
...
| **Recommended Rate** | $20,000/month (inclusive of dedicated engineer compensation, Kerzie AI principal margin, and infrastructure monitoring tools) |
...
### 5.5. Consultant Profile: Wade Kerzie
...
### 5.6. Phase 0 Deliverables: Architecture Engagement

The Phase 0 architecture engagement is designed to produce a comprehensive strategic and technical blueprint for the Vitalis proprietary infrastructure. The deliverables are organized into a four-week sprint, culminating in a complete handoff package for the Phase 1 deployment team. **This engagement is complete upon delivery of the handoff package. Production deployment is governed by the Phase 1 contract. Ongoing maintenance is governed by the Phase 2 managed services contract.**
...
**Phase 2 — Managed Services Retainer** ($20,000/month) should be contracted concurrently with Phase 0 and reflected in the Vitalis operating budget from the first month of operations. This is a monthly P&L operating expense — not a capital cost. At the recommended rate, Vitalis is purchasing a dedicated AI engineering team with principal-level oversight for less than the fully-loaded cost of a single senior in-house AI engineer in Dallas. The retainer scales with Vitalis: as new franchise locations come online, the scope expands under the same contract structure.
